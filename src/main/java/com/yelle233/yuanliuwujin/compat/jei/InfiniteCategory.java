 ...
 * 无限流体机器 JEI 配方分类。
 * <p>
 * 显示：虚空流体 → 任意流体，附带各核心等级转换比。
 */
public class InfiniteCategory implements IRecipeCategory<FluidConversionRecipe> {

    public static final RecipeType<FluidConversionRecipe> RECIPE_TYPE =
            RecipeType.create(SourceflowInfinite.MODID, "infinite", FluidConversionRecipe.class);
    ...
    public void draw(FluidConversionRecipe recipe, IRecipeSlotsView recipeSlotsView,
        ...
        int[] ratios = {
                Modconfigs.INFINITE_RATIO_L1.get(),
                Modconfigs.INFINITE_RATIO_L2.get(),
                Modconfigs.INFINITE_RATIO_L3.get(),
                Modconfigs.INFINITE_RATIO_L4.get(),
