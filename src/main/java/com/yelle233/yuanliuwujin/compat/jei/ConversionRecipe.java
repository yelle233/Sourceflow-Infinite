 ...
 * <p>
 * 化学品以 {@link Object} 存储（实际类型为 Mekanism 的 GasStack / InfusionStack /
 * PigmentStack / SlurryStack），避免在非 Mekanism 环境中触发类加载。
 *
 * @param fluidOther    非虚空流体（流体配方时有值，化学品配方时为 null）
 * @param chemicalOther 化学品（化学品配方时有值；流体配方时为 null）
 * @param chemicalAmount 化学品数量（mB）
